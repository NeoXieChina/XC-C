...
int main()
{
	...
	do {
		choice = MainMenu();
		switch (choice) {
			case 1:SearchMenu(TextBook,BookNumber);break;
			case 2:AddMenu(TextBook,BookNumber);break;
			case 3:EditMenu(TextBook,BookNumber);break;
			case 4:DeleteMenu(TextBook,BookNumber);break;
			case 5:PrintMenu(TextBook,BookNumber);break;
			case 6:exit(0);
			case 7:
			default:continue;
		}
